...
public class PrestamoCuotaEdm implements Comparable<PrestamoCuotaEdm>, Serializable {
	...
	public void fixDecimalScale(int newScale) {
		capital = capital.setScale(newScale, RoundingMode.HALF_UP);
		interes = interes.setScale(newScale, RoundingMode.HALF_UP);
		iva = iva.setScale(newScale, RoundingMode.HALF_UP);
		interesesGravados = interesesGravados.setScale(newScale, RoundingMode.HALF_UP);
